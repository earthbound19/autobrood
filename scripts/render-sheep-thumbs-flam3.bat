...
set format=jpg
set jpeg=85
REM set enable_jpeg_comments=1
REM set nick=openhatch
REM set url=http://openhatch.net
...
IF ERRORLEVEL 1 (
	...
	ECHO Writing note to render-sheep-thumbs-flam3-bat_errors.log . . .
	ECHO "Error encountered rendering %%S" >> render-sheep-thumbs-flam3-bat_errors.log
		)
